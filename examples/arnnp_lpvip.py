...
# arnnp_lpvip.py <- arnabs8xlnsnp2024r.py
# uses np LPVIP LNS (option for redundant LNS in dot prod)
###################################################
...
xl.sbdb_ufunc = xlnsconf.lpvip_ufunc.sbdb_ufunc_premitAddidealSub #uncomment for premit-add/above premit-sing-sub
#xl.sbdb_ufunc = xlnsconf.lpvip_ufunc.sbdb_ufunc_premitAddlpvipSub #uncomment for premit-add/above premit-sing-sub
#xl.sbdb_ufunc = xlnsconf.lpvip_ufunc.sbdb_ufunc_premitAddpremitSub #uncomment for premit-add/above premit-sing-sub
...
def main(main_params):
	...
	#XlnsExactsb = True 
	#XlnsExactdb = True
	print(" uses np LPVIP LNS (option for redundant LNS in dot prod)")
