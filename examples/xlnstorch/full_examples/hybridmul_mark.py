...
class LNSHybridMulMark(LNSOptimizer):
    r"""
    ...
    def __init__(
        ...
        super(LNSHybridMulMark, self).__init__(params, defaults)
    ...
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            lr = group["lr"]
#Mark changed the following line:
            signmul_term = group["base"] #group["signmul_term"]
            base = group["base"]
